export const createDataCacheTable = `
...
export const recruitmentSchemaStatements = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_recruitment_requests_type_status ON recruitment_requests (demand_type, status)`,
  `CREATE INDEX IF NOT EXISTS idx_recruitment_requests_created_at ON recruitment_requests (created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_recruitment_approvals_status ON recruitment_approvals (status)`
];
